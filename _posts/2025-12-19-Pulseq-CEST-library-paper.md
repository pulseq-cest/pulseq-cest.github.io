...
[**"The Pulseq-CEST Library**: definition of preparations and simulations, example data, and example evaluations"](https://link.springer.com/article/10.1007/s10334-025-01242-6 )

Pulseq-CEST files can be played out at a Siemens system directly with the Pulseq CEST hybrid sequence available upon request on C2P, or by combining any Pulseq-CEST preparation with any Pulseq sequence as described [here](https://github.com/kherz/pulseq-cest-library/blob/master/utils/demoCombination.m).
